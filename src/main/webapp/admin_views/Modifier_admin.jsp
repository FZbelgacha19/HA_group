	...
	<r:override name="adminContainer">
		<div class="d-flex justify-content-center">
			<form class="shadow-lg p-3 mb-5 bg-body rounded"
				action="Modifier_admin?id=${a.getId()}" method="post">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<span class="input-group-text"><i
							...
							class="form-control" placeholder="Nom complete" value="${a.getNom_complete()}">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<span class="input-group-text"><i class="bi bi-envelope"></i></span> <input id="email"
							...
							required="required" placeholder="Email" value="${a.getEmail()}">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<span class="input-group-text"><i class="bi bi-file-lock2"></i></span> <input
							...
							class="form-control" required="required" placeholder="Mot de passe" value="${a.getMotdpass()}">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<span class="input-group-text"><i class="bi bi-house"></i></span> <input id="adress"
							...
							required="required" placeholder="Address" value="${a.getAdress() }">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group">
						...
						<span class="input-group-text"><i class="bi bi-telephone"></i></span> <input id="tele"
							name="tele" type="tel" class="form-control" required="required" 
							placeholder="Numero de telephone" value="${a.getTele() }">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<span class="input-group-text"><i class="bi bi-calendar3"></i></span> <input
							...
							class="form-control" required="required" placeholder="Date de naissance" value="${a.getDateNaissance() }">
					</div>
				</div>
